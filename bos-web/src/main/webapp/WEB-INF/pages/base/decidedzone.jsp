...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1){
			...
			var url_1 = "decidezoneAction_findListNotAssociation.action";
			$.ajax({
				async:true,
				type:"POST",
				url:url_1,
			...
			var url_2 = "decidezoneAction_findListHasAssociation.action";
	...
	function doDblClickRow(index,data){
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "${pageContext.request.contextPath}/decidezoneAction_findListHasAssociation.action?id="+data.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="addDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addForm" action="${pageContext.request.contextPath}/decidezoneAction_add.action" method="post">
