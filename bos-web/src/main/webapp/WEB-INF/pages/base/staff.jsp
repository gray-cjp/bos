...
<script type="text/javascript">
	...
	$(function () {
		$("#save").click(function () {
			var flag = $("#staffCheck").form("validate");
			if (flag) {
				$("#staffCheck").submit();
			}
		});
	...
	$(function () {
		$("#edit").click(function () {
			var flag = $("#staffEdit").form("validate");
			if (flag) {
				$("#staffEdit").submit();
			}
		});
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="对收派员进行添加或者修改" id="addStaffWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="staffCheck" action="${pageContext.request.contextPath}/staffAction_save.action">
	...
	<div class="easyui-window" title="对收派员进行添加或者修改" id="editStaffWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="staffEdit" action="${pageContext.request.contextPath}/staffAction_edit.action">
