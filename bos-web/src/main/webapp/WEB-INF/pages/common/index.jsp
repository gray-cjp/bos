    ...
    <div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true" closed="true" resizable="false"
        ...
        <div class="easyui-layout" fit="true">
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
				<from id="editPasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input required="true" id="txtNewPass" type="Password" class="txt01 easyui-validatebox" data-options="validType:'length[4,6]'" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" class="txt01 easyui-validatebox" required="true" validType=equals['#txtNewPass'] data-options="validType:'length[4,6]'" /></td>
                    </tr>
                </table>
				</from>
            </div>
